...
export function TransferCard({ 
  ...
  return (
    <div className={`bg-white dark:bg-white/[0.02] rounded-xl shadow-sm border ${isBestMove ? 'border-amber-400 dark:border-amber-500/50 bg-amber-50/30 dark:bg-amber-500/10' : isWorstMove ? 'border-red-400 dark:border-red-500/50 bg-red-50/30 dark:bg-red-500/10' : 'border-gray-200 dark:border-white/10'} p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-all hover:shadow-md dark:hover:border-white/20`}>
      ...
      <div className="flex items-center gap-6 bg-gray-50 dark:bg-black/20 rounded-lg p-3 sm:bg-transparent sm:dark:bg-transparent sm:p-0">
        ...
        <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium shrink-0 w-36 justify-center border
          ${isGood ? 'bg-emerald-50 border-emerald-200 text-emerald-700 dark:bg-emerald-500/10 dark:border-emerald-500/20 dark:text-emerald-400' : ''}
          ${isChasing ? 'bg-red-50 border-red-200 text-red-700 dark:bg-red-500/10 dark:border-red-500/20 dark:text-red-400' : ''}
          ${isNeutral ? 'bg-gray-50 border-gray-200 text-gray-600 dark:bg-white/5 dark:border-white/10 dark:text-gray-300' : ''}
          ${isTooSoon ? 'bg-amber-50 border-amber-200 text-amber-700 dark:bg-amber-500/10 dark:border-amber-500/20 dark:text-amber-400' : ''}
        `}>
